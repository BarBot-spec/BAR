...
* (Scriptnya XP-TN&fiqking&caliph71)
...
const groupwa = 'https://chat.whatsapp.com/L8BVWfTQQcdBG0wlKdyf7O'; // OFFICIAL GRUP LU 1
...
conn.sendMessage(id, 'Akbar sibuk kak, Tunggu aja yah:)' ,MessageType.text);
}
else if (text == 'Lindy'){
